...
ORAZ GETTERY SETTERY I KONSTRUKTORY DLA KLAS!
...
Komputer komputer1 = new Komputer(1, 2.3, true, 32.0, 512.0, 2300.0, 5, "Acer turbo", 300);
        ...
        List<Komputer> list = new ArrayList<>(Arrays.asList(
                komputer1,
                komputer2,
                komputer3,
                komputer4,
        ...
        SklepKomputerowy sklepKomputerowy = new SklepKomputerowy(list);

W SklepKomputerowy zaimplementuj następujące metody:
...
public Komputer zwrocKomputerONajwyzszejPobieranejMocy(); (lub wyrzuć exception ValueNotFound())
public Komputer zwrocKomputerONajnizszejPobieranejMocy(); (lub wyrzuć exception ValueNotFound())
public Komputer zwrocKomputerONajnizszejPobieranejMocy(); (lub wyrzuć exception ValueNotFound())
public List<Komputer> zwrocKomputeryKtoreMajaTurboIDwaProcesory(); (lub wyrzuć exception ValueNotFound())
 */
